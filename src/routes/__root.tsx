...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@1,700&family=Frank+Ruhl+Libre:wght@400;700&family=Inter:wght@400;500;600;800&family=JetBrains+Mono:wght@400;500&display=swap" },
    ],
  }),
